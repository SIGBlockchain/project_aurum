...
func TestHandleAccountInfoRequest(t *testing.T) {
	...
	var walletAddress = block.HashSHA256(publickey.Encode(&privateKey.PublicKey))
...
func TestContractRequestHandler(t *testing.T) {
	...
	var recipientWalletAddress = block.HashSHA256(publickey.Encode(&recipientPrivateKey.PublicKey))
	...
	var walletAddress = block.HashSHA256(publickey.Encode(&senderPrivateKey.PublicKey))
