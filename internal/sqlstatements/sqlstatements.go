...
const (
	...
	CREATE_CONTRACT_TABLE                                   = "CREATE TABLE IF NOT EXISTS contracts (serialized_contract TEXT PRIMARY KEY, sender_pub_key TEXT, receipent_pub_key TEXT, nonce INTEGER)"
