...
const (
	...
	CREATE_CONTRACT_TABLE                                   = "CREATE TABLE IF NOT EXISTS contracts (serialized_contract BLOB PRIMARY KEY, sender_pub_key TEXT, nonce INTEGER)"
	...
	INSERT_VALUES_INTO_CONTRACTS                            = "INSERT INTO contracts (serialized_contract, sender_pub_key, nonce) VALUES (?, ?, ?)"
	...
	GET_CONTRACT_BY_PUBLIC_KEY_HASH             = "SELECT * FROM contracts WHERE sender_pub_key = ?"
