...
func GetBalance() (uint64, error) { return 99999999, errors.New("Incomplete Function") }

// READY TO BE IMPLEMENTED
func GetStateNonce() (uint64, error) { return 999999999, errors.New("Incomplete Function") }
