...
import (
	...
	"github.com/SIGBlockchain/project_aurum/internal/producer/src/genesis"
...
// 		}
// 	}()
// 	hashSlice, err := genesis.ReadGenesisHashes()
// 	if err != nil {
...
// 	}
// 	genesisBlock, err := genesis.BringOnTheGenesis(hashSlice, 1000)
// 	if err != nil {
...
// 	//airdrop
// 	err = genesis.Airdrop("blockchain.dat", constants.MetadataTable, constants.AccountsTable, genesisBlock)
// 	if err != nil {
